      ...
      <div className="footer-container">
        ...
        >
          ...
          <div>
            ...
            >
              Leveraging AI to transform businesses. We innovate, promote, and
              deliver the future of the digital employee experience.
            </p>
            <div style={{ display: 'flex', gap: '12px' }}>
              {/* Social icons - same as before but shortened for brevity */}
              <a
                href="#"
                style={{
                  width: '38px',
