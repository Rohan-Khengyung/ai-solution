          ...
          <div>
            ...
            <div style={{ display: 'flex', flexDirection: 'column', gap: '16px' }}>
              <div style={{ display: 'flex', gap: '10px', alignItems: 'flex-start' }}>
                ...
                <span style={{ color: '#64748b', fontSize: '0.9rem', lineHeight: 1.5 }}>Sunderland Tech Hub, Sunderland, UK SR1 3EQ</span>
              </div>
              <div style={{ display: 'flex', gap: '10px', alignItems: 'flex-start' }}>
                <span style={{ color: '#6366f1', marginTop: '2px', flexShrink: 0 }}>
                  <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2">
                ...
                <span style={{ color: '#64748b', fontSize: '0.9rem', lineHeight: 1.5 }}>+44 (0)191 123 4567</span>
              </div>
              <div style={{ display: 'flex', gap: '10px', alignItems: 'flex-start' }}>
                <span style={{ color: '#6366f1', marginTop: '2px', flexShrink: 0 }}>
                  <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2">
